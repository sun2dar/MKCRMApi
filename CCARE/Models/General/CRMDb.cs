...
//            modelBuilder.Entity<CustomerAddress>().ToTable("CRM.CustomerAddress");
            modelBuilder.Entity<CustomerAddress>().ToTable("CRM.CustomerAddressView");
            modelBuilder.Entity<StatusMapper>().ToTable("CRM.StatusMapper");
//            modelBuilder.Entity<Request>().ToTable("CRM.Request");
            modelBuilder.Entity<Request>().ToTable("CRM.RequestView");
//            modelBuilder.Entity<RequestAuditLog>().ToTable("CRM.RequestAuditLog");
            modelBuilder.Entity<RequestAuditLog>().ToTable("CRM.RequestAuditLogView");
//            modelBuilder.Entity<Customer>().ToTable("CRM.Customer");
            modelBuilder.Entity<Customer>().ToTable("CRM.CustomerView");
...
//            modelBuilder.Entity<Category>().ToTable("CRM.Category");
            modelBuilder.Entity<Category>().ToTable("CRM.CategoryView");
//            modelBuilder.Entity<Product>().ToTable("CRM.Product");
            modelBuilder.Entity<Product>().ToTable("CRM.ProductView");
//            modelBuilder.Entity<Branch>().ToTable("CRM.Branch");
            modelBuilder.Entity<Branch>().ToTable("CRM.BranchView");
//            modelBuilder.Entity<WSID>().ToTable("CRM.WsId");
            modelBuilder.Entity<WSID>().ToTable("CRM.WsIdView");
//            modelBuilder.Entity<BusinessUnit>().ToTable("CRM.BusinessUnit");
            modelBuilder.Entity<BusinessUnit>().ToTable("CRM.BusinessUnitView");
//            modelBuilder.Entity<ServiceLevel>().ToTable("CRM.ServiceLevel");
            modelBuilder.Entity<ServiceLevel>().ToTable("CRM.ServiceLevelView");
            modelBuilder.Entity<SecurityRole>().ToTable("CRM.SecurityRole");
//            modelBuilder.Entity<AccountPayment>().ToTable("CRM.AccountPayment");
            modelBuilder.Entity<AccountPayment>().ToTable("CRM.AccountPaymentView");
//            modelBuilder.Entity<OrganizationClosure>().ToTable("CRM.OrganizationClosure");
            modelBuilder.Entity<OrganizationClosure>().ToTable("CRM.OrganizationClosureView");
//            modelBuilder.Entity<LetterTemplate>().ToTable("CRM.LetterTemplate");
            modelBuilder.Entity<LetterTemplate>().ToTable("CRM.LetterTemplateView");
//            modelBuilder.Entity<SystemUser>().ToTable("CRM.SystemUser");
            modelBuilder.Entity<SystemUser>().ToTable("CRM.SystemUserView");
//            modelBuilder.Entity<Annotation>().ToTable("CRM.Annotation");
            modelBuilder.Entity<Annotation>().ToTable("CRM.AnnotationView");
//            modelBuilder.Entity<CallWrapUpCategory>().ToTable("CRM.CallWrapUpCategory");
            modelBuilder.Entity<CallWrapUpCategory>().ToTable("CRM.CallWrapUpCategoryView");
//            modelBuilder.Entity<Cause>().ToTable("CRM.Cause");
            modelBuilder.Entity<Cause>().ToTable("CRM.CauseView");
//            modelBuilder.Entity<Queue>().ToTable("CRM.Queue");
            modelBuilder.Entity<Queue>().ToTable("CRM.QueueView");
...
//            modelBuilder.Entity<LetterEntry>().ToTable("CRM.LetterEntry");
            modelBuilder.Entity<LetterEntry>().ToTable("CRM.LetterEntryView");
//            modelBuilder.Entity<NonCustomer>().ToTable("CRM.NonCustomer");
            modelBuilder.Entity<NonCustomer>().ToTable("CRM.NonCustomerView");
//            modelBuilder.Entity<QueueItem>().ToTable("CRM.QueueItem");
            modelBuilder.Entity<QueueItem>().ToTable("CRM.QueueItemView");
//            modelBuilder.Entity<Task>().ToTable("CRM.Task");
            modelBuilder.Entity<Task>().ToTable("CRM.TaskView");
//            modelBuilder.Entity<CallWrapUp>().ToTable("CRM.CallWrapUp");
            modelBuilder.Entity<CallWrapUp>().ToTable("CRM.CallWrapUpView");
...
//            modelBuilder.Entity<BroadcastMessageDetail>().ToTable("CRM.BroadcastMessageDetail");
            modelBuilder.Entity<BroadcastMessageDetail>().ToTable("CRM.BroadcastMessageDetailView");
...
//            modelBuilder.Entity<ProductTree>().ToTable("CRM.Product_Tree");
            modelBuilder.Entity<ProductTree>().ToTable("CRM.ProductTree");
//            modelBuilder.Entity<CategoryTree>().ToTable("CRM.Category_Tree");
            modelBuilder.Entity<CategoryTree>().ToTable("CRM.CategoryTree");
...
//            modelBuilder.Entity<Workflow>().ToTable("CRM.ViewWorkflow");
            modelBuilder.Entity<Workflow>().ToTable("CRM.WorkflowView");
//            modelBuilder.Entity<Request_Workflow>().ToTable("CRM.ViewRequest_Workflow");
            modelBuilder.Entity<Request_Workflow>().ToTable("CRM.Request_WorkflowView");
            ...
            //BTN
            modelBuilder.Entity<BtnWorkflow>().ToTable("CRM.BtnWorkflowView");
            modelBuilder.Entity<Contact>().ToTable("CRM.ContactView");
            modelBuilder.Entity<Activities>().ToTable("CRM.ActivityView");
            modelBuilder.Entity<ActivityType>().ToTable("CRM.SMAcitivityPointer_ActivityType");
        }
        ...
        public DbSet<BtnWorkflow> btnWorkflow { get; set; }
