...
{
    public class SMSTopUpController : Controller
    {
        ...
        public JsonResult ChangeBlockStatus()
        {
            ...
            Params param = new Params() { Parameter = new Dictionary<string, string>() };
            param.RequestTransType = "ChangeSMSTopUpStatusByMobileNo";
            ...
            ChangeStatusResult result = StatusUpdate.UserSMSTopUp(param);
