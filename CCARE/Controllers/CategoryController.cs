...
namespace CCARE.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public JsonResult LoadGrid(string sidx, string sord, int rows, int page = 1)
        {
            ...
            var model = db.category.Where(x => x.StateCode == stateCode && x.DeletionStateCode == 0);
            int totalRecords = 0;
        ...
        public ActionResult Edit(Guid id)
        {
            ...
            var parent = db.category
                        ...
                        .Where(x => x.ParentCategoryID == id).ToList();
        ...
        [HttpPost]
        public ActionResult ChangeStatus(Category model)
        {
